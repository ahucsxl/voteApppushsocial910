...
public class BroadcastController {
	...
	public static final String ACTION_USERCHANGE = "com.xl.net.ACTION_USERCHANGE";
	...
	public static void sendUserChangeBroadcase(Context context) {
		...
		Log.i("broadcastcontroller", "sendUserChangeBroadcase");
	}
	...
	public static void registerUserChangeReceiver(Context context, 
		...
		Log.i("broadcastcontroller", "registerUserChangeReceiver");
	}
	 ...
	 * @param receiver 广播接收器
	 * */
	public static void registerPushChangeReceiver(Context context, 
			BroadcastReceiver receiver) {
		IntentFilter filter = new IntentFilter(ACTION_PUSH_MESSAGE);
		context.registerReceiver(receiver, filter);
	}

...
import com.xl.voteapp.ui.LoginActivity;
import com.xl.voteapp.ui.MySelfInfoActivity;
import com.xl.voteapp.ui.PublishVoteActivity;
import com.xl.voteapp.ui.RegisterActivity;
...
public class UIHelper {
     ...
     * @param newsId
     */
    public static void showMySelfInfoActivity(Context context) {
     ...
     * @param blogId
     */
    public static void showPublishVoteActivity(Context context, int uno,String u_name,String u_portrait) {
        Intent intent = new Intent(context, PublishVoteActivity.class);
        intent.putExtra("uno",  String.valueOf(uno));
        intent.putExtra("u_name",  u_name);
        intent.putExtra("u_portrait",  u_portrait);
        context.startActivity(intent);
    }
    
    public static void showVoteActivity(Context context, int v_id,String v_title,String content,int u_no,ArrayList<Item> optionlist) {
        Intent intent = new Intent(context, VotingActivity.class);
        intent.putExtra("v_id", String.valueOf(v_id));
        intent.putExtra("u_no", String.valueOf(u_no));
        intent.putExtra("v_title", v_title);
        intent.putExtra("content", content);
        intent.putExtra("optionlist", (Serializable)optionlist);
        context.startActivity(intent);
    }
    
    public static void showDrawActivity(Context context, String title,String content, ArrayList<Item> optionlist) {
	...
	public static void showLoadImage(final ImageView imgView,
		...
		new Thread() {
			public void run() {
				...
				try {
					Bitmap bmp = getNetBitmap(imgURL);
					msg.what = 1;
					msg.obj = bmp;
